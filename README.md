...
and syncing those rows. At 00:02 in the middle of the night, it will trigger a new full sync,
just in case something bad happened to the binlog sync during the day.
...
It can also separately compare the table definitions as well and propose CREATE and ALTER commands.
But you have to make sure the table definitions are compatible for syncing from source to sink.
